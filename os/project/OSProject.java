...
public class OSProject {
    ...
    public static void main(String[] args) {
        ...
        /*fcfsProcesses.add(new Process(1, 0, 7, 0, 2, 2));
        fcfsProcesses.add(new Process(2, 3, 4, 0, 0, 2));
        ...
        /*rrProcesses.add(new Process(1, 0, 20, 0, 2, 1));
        rrProcesses.add(new Process(2, 3, 7, 0, 0, 0));
        rrProcesses.add(new Process(3, 5, 2, 0, 0, 0));
        rrProcesses.add(new Process(4, 7, 3, 0, 0, 0));
